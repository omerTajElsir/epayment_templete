...
List<TabsInfo> tabInfo = [
  TabsInfo(
      ...
      text1: AppLocalizations.of(_bc).tr('intro.title1'),
      text2: 'Lorem Ipsum',
      skipButton: AppLocalizations.of(_bc).tr('intro.skip'),
      nextButton: AppLocalizations.of(_bc).tr('intro.next')),
  TabsInfo(
      imagePath: 'assets/tab/Onboarding-02.png',
      text1: AppLocalizations.of(_bc).tr('intro.title2'),
      text2: 'Lorem Ipsum',
      skipButton: AppLocalizations.of(_bc).tr('intro.prev'),
      nextButton: AppLocalizations.of(_bc).tr('intro.next')),
  TabsInfo(
      imagePath: 'assets/tab/Onboarding-03.png',
      text1: AppLocalizations.of(_bc).tr('intro.title3'),
      text2: 'Lorem Ipsum',
      skipButton: '',
      nextButton: AppLocalizations.of(_bc).tr('intro.signup'))
];
List<String> images = ["assets/tab/Onboarding-01.png", "assets/tab/Onboarding-02.png", "assets/tab/Onboarding-03.png"];
    ...
    return Scaffold(
        body: Stack(children: <Widget>[
          ...
          Positioned(
              ...
              bottom: 140,
              child: Text(
                tabInfo[_index].text2,style : TextStyle(color : Colors.black),
                textAlign: TextAlign.center,
              )),
          Positioned(
            left: 0.0,
                    ...
                    switch (tabInfo[_index].nextButton) {
                      ...
                      case 'Signup':
                        Navigator.of(context).pushReplacement(
                            MaterialPageRoute(builder: (context) => RigisterPage()));
                        break;
                    }
                  }else if(Localizations.localeOf(context).languageCode == "ar"){
                    switch (tabInfo[_index].nextButton) {
