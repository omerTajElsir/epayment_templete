...
import 'package:epayment_templete/pages/fingerprint.dart';
...
class _ConfirmPageState extends State<ConfirmPage>
  ...
  get _getPhoneNumberLabel {
    return new Text(
      "+249${widget.phoneNumber}",
      textAlign: TextAlign.center,
      style: new TextStyle(fontSize: 28.0, color: Color(0xffDBA14F)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          return new Text(
            timerString,
            style: new TextStyle(fontSize: fontSize, color: timeColor),
          );
        });
  }
}
