...
class _TopUpState extends State<TopUp> {
  ...
  Color mtnC=Colors.transparent,canarC=Colors.black54,zainC=Colors.black54,sudC=Colors.black54;
            ...
            child: Column(
              ...
              children: <Widget>[
                      ...
                      Container(
                        child: Row(
                          children: <Widget>[
                            ...
                            Container(
                                child: Text(
                                  AppLocalizations.of(context).tr('TopUp.title'),
                                  style: TextStyle(
                                      color: Colors.grey[800],
                                      fontSize: 20,
                ...
                Container(
                  ...
                  child: Text(AppLocalizations.of(context).tr('TopUp.select_operator'),style: TextStyle(color: Colors.grey[700],fontSize: 20),),
                ),
                SizedBox(height: 20,),
                Container(
                  height: 100,
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:  AppLocalizations.of(context).tr('TopUp.phone'),
                ...
                Container(
                  ...
                  child: TextFormField(
                    keyboardType: TextInputType.phone,
                    decoration: InputDecoration(
                      labelText:  AppLocalizations.of(context).tr('TopUp.amount'),
                      labelStyle: TextStyle(color: Colors.grey[700]),
                      focusedBorder:UnderlineInputBorder(
                        borderSide: const BorderSide(color: Colors.black, width: 2.0),
                      ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: Center(
                        child: Text( AppLocalizations.of(context).tr('TopUp.pay'),style: TextStyle(color: Colors.grey[100],fontSize: 22,fontWeight: FontWeight.w600),),
                      )
                  ),
                ),
              ],
